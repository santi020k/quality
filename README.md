...
> Status: `1.x` stable. Public CLI, configuration, report, and Action contracts follow the
...
`actions/setup-pnpm` from this repository to share setup while keeping deployment
...
macOS, and Windows whenever a version tag such as `v1.0.0` is pushed.
